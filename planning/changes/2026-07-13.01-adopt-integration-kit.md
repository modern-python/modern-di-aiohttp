---
summary: Compose modern_di.integrations instead of hand-rolling the connection-scope derivation and the FromDI/parse/resolve triad; no public-API change.
---
