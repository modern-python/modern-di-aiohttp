...
[Writing an integration](https://modern-di.modern-python.org/integrations/writing-integrations/) guide
...
- `planning/` — planning-convention bundle mirrored from starlette; this design
  becomes `planning/changes/2026-07-02.01-di-integration.md` with a
